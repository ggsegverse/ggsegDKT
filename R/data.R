...
#' with 31 regions per hemisphere. Contains both 2D polygon geometry
#' for [ggseg::ggseg()] and 3D vertex indices for [ggseg3d::ggseg3d()].
#'
#' @docType data
#' @name dkt
#' @usage data(dkt)
...
#'   consistent human cortical labeling protocol.
