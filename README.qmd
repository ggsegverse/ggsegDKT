...
[![R-CMD-check](https://github.com/ggseg/ggsegDKT/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/ggseg/ggsegDKT/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->

This package contains dataset for plotting the DKT cortical atlas with ggseg and ggseg3d.
